      ...
      @yield('cont')
        <div style="background-color: black;">
            ...
            <div class="col-md-4 d-flex align-items-center p-2">
                <a href="/inicio" class="mb-3 me-2 mb-md-0 text-light text-decoration-none lh-1">
                    <svg class="bi" width="30" height="24"><use xlink:href="#Clock"/></svg>
                </a>
                <span class="mb-3 mb-md-0 text-light">Cargas Horarias A la Hora Del Día</span>
            </div>
